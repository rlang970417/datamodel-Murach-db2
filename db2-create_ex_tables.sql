/*******************************************************************************
   ...
   EX Schema
   Script: db2-create_ex_tables.sql
   Description: Creates and populates the EX tables for the RPT1 database.
   DB Server: Db2
...
/*******************************************************************************
   Create Tables
********************************************************************************/
CREATE TABLE ex.active_invoices
(
...
(
  ...
  color_number  INTEGER            DEFAULT 0   NOT NULL,
  color_name    VARCHAR(10)
);

CREATE TABLE ex.customers
(
...
CREATE TABLE ex.float_sample
(
  float_id       INTEGER,
  float_value    DOUBLE
);

CREATE TABLE ex.null_sample
(
  invoice_id      INTEGER            NOT NULL,
...
CREATE TABLE ex.projects
(
  project_number    VARCHAR(5)   NOT NULL,
  employee_id       INTEGER        NOT NULL
);

CREATE TABLE ex.string_sample
(
  id        VARCHAR(3),
  name      VARCHAR(25)
);
...
-- INSERT INTO ex.active_invoices
...
INSERT INTO ex.customers VALUES (1, 'Anders', 'Maria', '345 Winchell Pl', 'Anderson', 'IN', '46014', '(765) 555-7878');
INSERT INTO ex.customers VALUES (2, 'Trujillo', 'Ana', '1298 E Smathers St', 'Benton', 'AR', '72018', '(501) 555-7733');
INSERT INTO ex.customers VALUES (3, 'Moreno', 'Antonio', '6925 N Parkland Ave', 'Puyallup', 'WA', '98373', '(253) 555-8332');
INSERT INTO ex.customers VALUES (4, 'Hardy', 'Thomas', '83 d''Urberville Ln', 'Casterbridge', 'GA', '31209', '(478) 555-1139');
INSERT INTO ex.customers VALUES (5, 'Berglund', 'Christina', '22717 E 73rd Ave', 'Dubuque', 'IA', '52004', '(319) 555-1139');
INSERT INTO ex.customers VALUES (6, 'Moos', 'Hanna', '1778 N Bovine Ave', 'Peoria', 'IL', '61638', '(309) 555-8755');
INSERT INTO ex.customers VALUES (7, 'Citeaux', 'Fred', '1234 Main St', 'Normal', 'IL', '61761', '(309) 555-1914');
INSERT INTO ex.customers VALUES (8, 'Summer', 'Martin', '1877 Ete Ct', 'Frogtown', 'LA', '70563', '(337) 555-9441');
INSERT INTO ex.customers VALUES (9, 'Lebihan', 'Laurence', '717 E Michigan Ave', 'Chicago', 'IL', '60611', '(312) 555-9441');
INSERT INTO ex.customers VALUES (10, 'Lincoln', 'Elizabeth', '4562 Rt 78 E', 'Vancouver', 'WA', '98684', '(360) 555-2680');
INSERT INTO ex.customers VALUES (11, 'Snyder', 'Howard', '2732 Baker Blvd.', 'Eugene', 'OR', '97403', '(503) 555-7555');
INSERT INTO ex.customers VALUES (12, 'Latimer', 'Yoshi', 'City Center Plaza 516 Main St.', 'Elgin', 'OR', '97827', '(503) 555-6874');
INSERT INTO ex.customers VALUES (13, 'Steel', 'John', '12 Orchestra Terrace', 'Walla Walla', 'WA', '99362', '(509) 555-7969');
INSERT INTO ex.customers VALUES (14, 'Yorres', 'Jaime', '87 Polk St. Suite 5', 'San Francisco', 'CA', '94117', '(415) 555-5938');
INSERT INTO ex.customers VALUES (15, 'Wilson', 'Fran', '89 Chiaroscuro Rd.', 'Portland', 'OR', '97219', '(503) 555-9573');
INSERT INTO ex.customers VALUES (16, 'Phillips', 'Rene', '2743 Bering St.', 'Anchorage', 'AK', '99508', '(907) 555-7584');
INSERT INTO ex.customers VALUES (17, 'Wilson', 'Paula', '2817 Milton Dr.', 'Albuquerque', 'NM', '87110', '(505) 555-5939');
INSERT INTO ex.customers VALUES (18, 'Pavarotti', 'Jose', '187 Suffolk Ln.', 'Boise', 'ID', '83720', '(208) 555-8097');
INSERT INTO ex.customers VALUES (19, 'Braunschweiger', 'Art', 'P.O. Box 555', 'Lander', 'WY', '82520', '(307) 555-4680');
INSERT INTO ex.customers VALUES (20, 'Nixon', 'Liz', '89 Jefferson Way Suite 2', 'Providence', 'RI', '02909', '(401) 555-3612');
INSERT INTO ex.customers VALUES (21, 'Wong', 'Liu', '55 Grizzly Peak Rd.', 'Butte', 'MT', '59801', '(406) 555-5834');
INSERT INTO ex.customers VALUES (22, 'Nagy', 'Helvetius', '722 DaVinci Blvd.', 'Concord', 'MA', '01742', '(351) 555-1219');
INSERT INTO ex.customers VALUES (23, 'Jablonski', 'Karl', '305 - 14th Ave. S. Suite 3B', 'Seattle', 'WA', '98128', '(206) 555-4112');
INSERT INTO ex.customers VALUES (24, 'Chelan', 'Donna', '2299 E Baylor Dr', 'Dallas', 'TX', '75224', '(469) 555-8828');

-- INSERT INTO ex.date_sample

INSERT INTO ex.date_sample VALUES (1, TO_DATE('1979-03-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO ex.date_sample VALUES (2, TO_DATE('1999-02-28 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO ex.date_sample VALUES (3, TO_DATE('2003-10-31 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO ex.date_sample VALUES (4, TO_DATE('2005-02-28 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO ex.date_sample VALUES (5, TO_DATE('2006-02-28 13:58:32', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO ex.date_sample VALUES (6, TO_DATE('2006-03-01 09:02:25', 'YYYY-MM-DD HH24:MI:SS'));

-- INSERT INTO ex.departments 

INSERT INTO ex.departments (department_number,department_name) VALUES
(1,'Accounting');
INSERT INTO ex.departments (department_number,department_name) VALUES
(2,'Payroll');
INSERT INTO ex.departments (department_number,department_name) VALUES
...
-- INSERT INTO ex.float_sample 

INSERT INTO ex.float_sample VALUES (1, 0.999999999999999);
INSERT INTO ex.float_sample VALUES (2, 1);
INSERT INTO ex.float_sample VALUES (3, 1.000000000000001);
INSERT INTO ex.float_sample VALUES (4, 1234.56789012345);
INSERT INTO ex.float_sample VALUES (5, 999.04440209348);
INSERT INTO ex.float_sample VALUES (6, 24.04849);


-- INSERT INTO ex.null_sample 

INSERT INTO ex.null_sample (invoice_id,invoice_total) VALUES (1,125);
INSERT INTO ex.null_sample (invoice_id,invoice_total) VALUES (2,0);
INSERT INTO ex.null_sample (invoice_id,invoice_total) VALUES (3,null);
INSERT INTO ex.null_sample (invoice_id,invoice_total) VALUES (4,2199.99);
INSERT INTO ex.null_sample (invoice_id,invoice_total) VALUES (5,0);

-- INSERT INTO ex.paid_invoices
...
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1011',8);
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1011',4);
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1012',3);
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1012',1);
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1012',5);
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1013',6);
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1013',9);
INSERT INTO ex.projects (project_number,employee_id) VALUES ('P1014',10);

-- INSERTING into STRING_SAMPLE

INSERT INTO ex.string_sample VALUES ('1', 'Lizbeth Darien');
INSERT INTO ex.string_sample VALUES ('2', 'Darnell O''Sullivan');
INSERT INTO ex.string_sample VALUES ('17', 'Lance Pinos-Potter');
INSERT INTO ex.string_sample VALUES ('20', 'Jean Paul Renard');
INSERT INTO ex.string_sample VALUES ('3', 'Alisha von Strump');
