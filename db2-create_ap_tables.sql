/*******************************************************************************
   ...
   AP Schema
   Script: db2-create_ap_tables.sql
   Description: Creates and populates the AP tables for the RPT1 database.
   DB Server: Db2
...
(
  ...
  CONSTRAINT vendors_fk_terms
    ...
    REFERENCES ap.terms (terms_id),
  CONSTRAINT vendors_fk_accounts
    FOREIGN KEY (default_account_number) 
    REFERENCES ap.general_ledger_accounts (account_number)
);
...
CREATE TABLE ap.invoice_line_items
(
  invoice_id              INTEGER        NOT NULL,
  invoice_sequence        INTEGER        NOT NULL,
  account_number          INTEGER        NOT NULL,
  line_item_amt           DECIMAL(9,2)   NOT NULL,
  ...
  CONSTRAINT line_items_fk_invoices
    FOREIGN KEY (invoice_id) REFERENCES ap.invoices (invoice_id),
  CONSTRAINT line_items_fk_acounts
    FOREIGN KEY (account_number) REFERENCES ap.general_ledger_accounts (account_number)
);

CREATE TABLE ap.vendor_contacts
(
  vendor_id       INTEGER        NOT NULL,
...
CREATE TABLE ap.invoice_archive
(
  invoice_id          INTEGER          NOT NULL,
  vendor_id           INTEGER          NOT NULL,
  invoice_number      VARCHAR(50)    NOT NULL,
...
/*******************************************************************************
  Create the indexes
********************************************************************************/
CREATE INDEX vendors_terms_id_ix ON ap.vendors (default_terms_id);
CREATE INDEX vendors_account_number_ix ON ap.vendors (default_account_number);
CREATE INDEX invoices_invoice_date_ix ON ap.invoices (invoice_date DESC);
CREATE INDEX invoices_vendor_id_ix ON ap.invoices (vendor_id);
CREATE INDEX invoices_terms_id_ix ON ap.invoices (terms_id);
CREATE INDEX line_items_account_number_ix ON ap.invoice_line_items (account_number);

/******************************************************************************
  Insert Data
*******************************************************************************/
-- INSERT INTO ap.general_ledger_accounts
INSERT INTO ap.general_ledger_accounts (account_number,account_description)
VALUES (100,'Cash');
INSERT INTO ap.general_ledger_accounts (account_number,account_description)
...
INSERT INTO ap.terms (terms_id,terms_description,terms_due_days) VALUES (1,'Net due 10 days',10);
INSERT INTO ap.terms (terms_id,terms_description,terms_due_days) VALUES (2,'Net due 20 days',20);
INSERT INTO ap.terms (terms_id,terms_description,terms_due_days) VALUES (3,'Net due 30 days',30);
INSERT INTO ap.terms (terms_id,terms_description,terms_due_days) VALUES (4,'Net due 60 days',60);
INSERT INTO ap.terms (terms_id,terms_description,terms_due_days) VALUES (5,'Net due 90 days',90);
...
-- INSERT INTO ap.vendor_contacts
INSERT INTO ap.vendor_contacts (vendor_id,last_name,first_name) VALUES
(5,'Davison','Michelle');
INSERT INTO ap.vendor_contacts (vendor_id,last_name,first_name) VALUES
(12,'Mayteh','Kendall');
INSERT INTO ap.vendor_contacts (vendor_id,last_name,first_name) VALUES
...
-- INSERTING into ap.invoice_line_items
